...
## Project Structure
    ...
    ├── testapiautoconnecto_75019  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_75019`
...
2. Clone this repo and `cd testapiautoconnecto_75019`
